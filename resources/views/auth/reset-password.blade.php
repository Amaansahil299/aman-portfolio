...
@section('content')
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-inputs.input-label id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-inputs.input-label id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
        ...
        <div class="mt-4">
            ...
            <x-inputs.input-label id="password_confirmation" class="block mt-1 w-full"
                                  type="password"
