...
@section('content')
    ...
    <div class="flex mx-10 mt-4 gap-16">
        <div class="hidden md:block w-[320px] ">


            <div class="mb-2 p-3 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">


                <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-2">
                    Accessories Related Stores
