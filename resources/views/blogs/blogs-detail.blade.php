...
@section('content')
    ...
    <section  class=" pb-10  lg:pb-20 dark:bg-dark bg-white ">
        <div class="p-0">
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 ">
                    <div
                        class="wow fadeInUp relative  mb-[50px] h-[300px] overflow-hidden rounded-[5px] md:h-[100px] lg:h-[400px]"
                        data-wow-delay=".1s"
                    >

                        <img src="{{ asset('storage/' . $blog->thumbnail) }}" alt="image"
                             class="h-full w-full object-cover object-center" />
                        <div
                            class="absolute top-0 left-0  flex h-full w-full items-end bg-gradient-to-t from-dark-700 to-transparent">
                            <div class="flex flex-wrap items-center p-4 pb-4 sm:px-8">
                                <div class="mb-4 mr-5 flex items-center md:mr-10">
                                    <div class="mr-4 h-10 w-10 overflow-hidden rounded-full">
                                        <img src="https://plus.unsplash.com/premium_photo-1671076131210-5376fccb100b?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGNvdXBvbnN8ZW58MHx8MHx8fDA%3D" alt="image" class="w-full" />
                                    </div>
                    ...
                    <div class="flex flex-wrap gap-10">
                        <div class="w-full pl-10 lg:w-1/4  hidden md:block m-6 mr-0 pt-8">

                            <x-common.share-social-component />
                        </div>
                        <div class="w-full lg:w-2/4 pl-20">
                            <p class="mt-6 text-2xl font-extrabold tracking-tight text-black md:text-4xl">

                                <span class="md:block">  {{ $blog->title }}</span>
            ...
            <div class="m-5 md:m-20 mt-4 md:mt-4 flex flex-wrap  ">
