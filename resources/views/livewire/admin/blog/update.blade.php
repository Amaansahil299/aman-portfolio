<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('UpdateTitle', ['name' => __('Blog') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                ...
                <input type='file' id='input-thumbnail' wire:model='thumbnail' class="form-control-file  @error('thumbnail') is-invalid @enderror">
