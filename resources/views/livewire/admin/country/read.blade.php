            ...
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if(getCrudConfig('Country')->create && hasPermission(getRouteName().'.country.create', 1, 0))
                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('code')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'code') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'code') fa-sort-amount-up ml-2 @endif'></i> {{ __('Code') }} </th>
                    ...
                    <tbody>
                        @foreach($countrys as $country)
                            @livewire('admin.country.single', [$country], key($country->id))
                        @endforeach
                    </tbody>
                </table>
            </div>
